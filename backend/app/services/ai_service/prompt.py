      ...
      "items": [
        {
          ...
          "latitude": 经度坐标或null,
          "longitude": 纬度坐标或null,
          "reason": "推荐理由：结合预算等级、兴趣、随行人群、天气写一句具体有人情味的话，30~45字",
...
7. reason 必须具体、有人情味，禁止套话（按第十一节的要求写）
...
## 十一、推荐理由写作要求（重要）
每个地点的 reason 要让用户感觉"这个安排懂我"，像熟悉当地的朋友在推荐，而不是百科介绍：
- 必须结合具体场景：消费等级、兴趣偏好、随行人群（老人/儿童/情侣等）、当天天气、当天行程节奏
- 用口语化、有温度的表达，写清"为什么这个安排适合 TA、怎么玩更好"
- 禁止套话和空洞形容词："著名景点""值得一去""打卡必去""风景优美""人气很旺"等一律不用
- 字数 30~45 字，一句话说清，不写空话

示例：
- 亲子 + 雨天："儿童科技馆，雨天也能玩一整天，动手项目多，正好避雨又不累"
- 美食偏好 + 经济型："老字号生煎，人均十几块，本地人从小吃到大，不踩雷"
- 摄影偏好 + 傍晚："外滩观景台，日落前后光线最好，能拍到陆家嘴夜景亮灯"
- 老人 + 舒适型节奏："公园慢走约40分钟，路平树荫多，适合长辈不赶时间地逛"
- 情侣 + 高品质："江景餐厅露台位，边吃边看夜景，纪念日氛围感拉满"
"""
